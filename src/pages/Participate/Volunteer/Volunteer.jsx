    ...
    return (
      <div className={styles.container}>
		    ...
		    <div className={styles.sidebar}>
		    	...
		    	<h2 className={styles.header}>Individual and Person Group Volunteers</h2>
		    	<p>From participating in the annual Greater Chicago Food Depository Hunger Walk to helping children find their voice at the Phoenix, Illinois Family Reading Night, Life Quilt volunteers have the privilege of serving in the community in a number of ways. </p>
