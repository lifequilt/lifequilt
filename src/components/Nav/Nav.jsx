...
const Nav = props => (
  <nav className={styles.nav}>
    <Link to="/about" className={props.location.pathname === '/about' ? styles.navItemActive : styles.navItem}>About</Link>
    ...
    <Link to="/donate" className={props.location.pathname === '/donate' ? styles.navItemActive : styles.navItemDonate}>Donate</Link>
  </nav>
);
